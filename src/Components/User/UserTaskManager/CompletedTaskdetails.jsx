...
const CompletedTaskdetails = () => {
    ...
    const { completedjobs, loading } = useSelector((state) => state.task)
                        ...
                        <>
                            {
                                completedjobs?.length > 0 ? (
                                    ...
                                    <>
                                        <h2 style={{ textAlign: "center", fontFamily: "Times", fontWeight: "600", marginTop: "10px", color: "green" }}>No Completed Project Present in your Accounts</h2>
                                    </>
                                )
                            }
                        </>
